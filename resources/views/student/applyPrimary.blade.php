                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="multisteps-form__form needs" novalidate action="#">
                                            ...
                                            <!--single form panel for interview results -->
                                            <div class="multisteps-form__panel" data-animation="FadeIn">
                                                <div class="row text-center mt-4">
                                                    <div class="col-10 mx-auto">
                                                        <h5 class="font-weight-normal">Interview results
                                                        </h5>
                                                        <p>Please fill the fields below.</p>
                                                    </div>
                                                </div>
                                                <div class="multisteps-form__content">
                                                    <div class="row mt-4">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="input-group input-group-dynamic mb-4">
                                                                <label class="form-label">Literacy 1</label>
                                                                <input type="number" 
                                                                    class="form-control multisteps-form__input">
                                                            </div>
                                                            <div class="input-group input-group-dynamic mb-4">
                                                                <label class="form-label">Literacy 2</label>
                                                                <input type="number"
                                                                    class="form-control multisteps-form__input">
                                                            </div>
                                            ...
                                            <!--end single form panel fro interview results -->
